...
import { UploadCloud, FileText, LogOut, Zap, Menu, X, LayoutDashboard } from 'lucide-react'
...
export default function Sidebar() {
  ...
  return (
    <>
        ...
        <div className="border-t border-sidebar-border px-2 py-3">
          {!collapsed && (
            <div className="px-3 py-2 mb-1">
              <p className="text-xs font-semibold text-slate-300 truncate capitalize">{user?.name}</p>
      ...
      {/* Spacer */}
      <div className={`flex-shrink-0 transition-all duration-300 ${collapsed ? 'w-[68px]' : 'w-56'}`} />
    </>
  )
}
